    ...
    return (
        <div data-aos="fade-up" className="w-[100%] flex items-center justify-between border-b border-gray-800 pb-5">
            <div className="flex items-center lg:gap-5 md:gap-4 gap-2">
                ...
                <div>
                    <Link to={trackAlbum !== "" ? `/track/${trackId}` : ""}><p className="lg:text-lg md:text-base text-sm font-semibold lg:w-[27rem] md:w-[24rem] w-[13rem] truncate">{trackAlbum ? trackName : "Not Available"}</p></Link>
