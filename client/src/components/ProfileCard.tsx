...
const ProfileCard = ({ data, logout, totalPlaylists, topGenres }: any) => {
    return (
        <div data-aos="zoom-in-up" className="m-auto mt-16 flex flex-col items-center justify-center">
            <div>
                <img loading="eager" src={data?.user.images.length !== 0 ? data?.user.images[1].url : "https://maheshwaricollege.ac.in/publicimages/thumb/members/400x400/mgps_file_d11584807164.jpg"} className="lg:h-44 h-36 w-36 lg:w-44 rounded-full" alt="Avatar" />
            </div>
