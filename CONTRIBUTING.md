...
## How to Contribute to SpotiStat
...
## Code of Conduct
We expect all contributors to follow our [code of conduct](https://github.com/SudhansuuRanjan/Spotistat/blob/main/CODE_OF_CONDUCT.md). Please be respectful and inclusive in your communication and interactions with other contributors.
...
`$ git clone https://github.com/SudhansuuRanjan/Spotistat.git` <br/>
...
`$ git remote add upstream https://github.com/SudhansuuRanjan/Spotistat.git` <br/>
